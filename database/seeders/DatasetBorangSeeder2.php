...
class DatasetBorangSeeder2 extends Seeder
{
    public function run()
    {
    ...
    // Karena response sudah sangat panjang, saya akan lanjutkan dengan template HTML di response berikutnya
    // Tapi saya berikan contoh beberapa template dulu:
...
HTML;
    ...
    // ========================================
    // TEMPLATE HTML HELPERS (Lanjutan)
    // ========================================
