...
class IndikatorPenilaianElemenSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            ['elemen' => 'Visi, Misi, Tujuan, dan Strategi', 'penilaian' => "1) Terdapat bukti keterlibatan aktif dari pengampu kepentingan eksternal (asosiasi, lembaga pemerintah, lembaga nonpemerintah yang secara spesifik relevan) dalam rangka memastikan relevansi visi misi dan\n2) PT-UPPS-Program Studi mampu menunjukkan proses evaluasi untuk menjamin relevansi serta keberlanjutan penyelenggaraan pendidikan tinggi. dan bukti keterlibatan aktif dari pengampu kepentingan eksternal (asosiasi, lembaga pemerintah, lembaga nonpemerintah yang secara spesifik relevan) dalam rangka memastikan relevansi visi misi", 'skor' => 4],
        ];
