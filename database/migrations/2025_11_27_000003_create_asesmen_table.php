...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('asesmen_kecukupan_banding', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('asesmen_lapangan_banding', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('asesmen_banding', function (Blueprint $table) {
            ...
            $table->date('tanggal_mulai')->nullable();
            $table->date('tanggal_selesai')->nullable();
            $table->string('status')->default('active'); // active | selesai | dilaporkan
            $table->text('catatan')->nullable();
            $table->timestamps();

            $table->unique('id_asesmen'); // 1 asesmen = 1 surveillance
        });
        ...
        Schema::create('asesmen_user_roles', function (Blueprint $table) {
            ...
            $table->enum('jenis_asesmen', ['ak', 'al', 'dokumen', 'ak_banding', 'al_banding'])->default('ak');
            $table->foreignId('id_asesmen_kecukupan')
                ->nullable()
                ->constrained('asesmen_kecukupan')
                ->onDelete('cascade');
            ...
            $table->foreignId('id_asesmen_kecukupan_banding')
                ->nullable()
                ->constrained('asesmen_kecukupan_banding')
                ->onDelete('cascade');
            $table->foreignId('id_asesmen_lapangan_banding')
                ->nullable()
                ->constrained('asesmen_lapangan_banding')
                ->onDelete('cascade');
            ...
            $table->index(['id_asesmen_kecukupan_banding', 'id_role']);
            $table->index(['id_asesmen_lapangan_banding', 'id_role']);
            $table->index('urutan_asesor');
            $table->boolean('is_active')->default(true)->index();
            $table->boolean('is_example')->default(false)->index();
            $table->unique(
                ['id_asesmen', 'id_user', 'jenis_asesmen', 'id_role'],
        ...
        Schema::create('asesmen_documents', function (Blueprint $table) {
            ...
            $table->enum('status_persetujuan_prodi', ['pending', 'approved', 'revision_required', 'rejected'])->default('pending');
            $table->foreignId('approved_by_prodi')->nullable()->constrained('users')->nullOnDelete();
            $table->timestamp('approved_at_prodi')->nullable();
            $table->text('catatan_prodi')->nullable();

            $table->enum('status_persetujuan_de', ['pending', 'approved',  'revision_required', 'rejected'])->default('pending');
            $table->foreignId('approved_by_de')->nullable()->constrained('users')->nullOnDelete();
            $table->timestamp('approved_at_de')->nullable();
            $table->text('catatan_de')->nullable();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('asesmen_lapangan_banding');
        Schema::dropIfExists('asesmen_kecukupan_banding');
