...
class AsesmenLapanganBanding extends Model
{
    use HasFactory;

    protected $table = 'asesmen_lapangan_banding';
    ...
    {
        return $this->hasMany(AsesmenUserRole::class, 'id_asesmen_lapangan_banding');
    }
    ...
    public function getMissingRequirements()
    {
        ...
        if ($asesorCount < 2) {
            $missing[] = 'Kurang ' . (2 - $asesorCount) . ' asesor_banding';
        }
    ...
    public function getMissingRequirementsWithCounts(int $asesorCount): array
    {
        ...
        if ($asesorCount < 2) $missing[] = 'Kurang ' . (2 - $asesorCount) . ' asesor_banding';
