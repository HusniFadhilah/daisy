...
class AsesmenKecukupanBanding extends Model
{
    use HasFactory;

    protected $table = 'asesmen_kecukupan_banding';
    ...
    {
        return $this->hasMany(AsesmenUserRole::class, 'id_asesmen_kecukupan_banding');
    }
    ...
    public function getMissingRequirements()
    {
        ...
        if ($asesorCount < 2) {
            $missing[] = 'Kurang ' . (2 - $asesorCount) . ' asesor banding';
        }
    ...
    public function getMissingRequirementsWithCounts(int $asesorCount, int $validatorCount): array
    {
        ...
        if ($asesorCount < 2) $missing[] = 'Kurang ' . (2 - $asesorCount) . ' asesor banding';
