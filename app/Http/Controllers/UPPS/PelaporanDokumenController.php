<?php
// app/Http/Controllers/UPPS/PelaporanDokumenController.php
...
class PelaporanDokumenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('upps.pelaporan-dokumen.index', compact(
            'pengajuans',
            'stats',
            'tahunList'
        ));
    ...
    public function show($id)
    {
        ...
        return view('upps.pelaporan-dokumen.show', compact('pengajuan'));
    }
    ...
    private function calculateStatistics($studyProgramIds): array
    {
        ...
        foreach ($logsByPengajuan as $pengajuanId => $pengajuanLogs) {
            ...
            // Tervalidasi: sudah validated
            if (in_array(PengajuanAkreditasi::STATUS_BORANG_VALIDATED, $statuses)) {
                $stats['tervalidasi']++;
            }

            // Terlaporkan: sudah dilaporkan atau lebih lanjut
            if (
                in_array(PengajuanAkreditasi::STATUS_VALIDASI_BORANG_DILAPORKAN, $statuses) ||
