<?php
// app/Http/Controllers/UPPS/ValidasiAKController.php
...
{
    /**
     * Display list of validasi hasil AK
     */
    public function index(Request $request)
    {
        ...
        return view('upps.validasi-ak.index', compact(
            'pengajuans',
            'stats',
            'tahunList'
        ));
    ...
    public function show($id)
    {
        ...
        return view('upps.validasi-ak.show', compact('pengajuan'));
    }
    ...
    private function calculateStatistics($studyProgramIds): array
    {
        ...
        foreach ($logsByPengajuan as $pengajuanId => $pengajuanLogs) {
            ...
            // Penilaian AK: sudah ada asesor yang melakukan penilaian
            if (
            ...
            // Tervalidasi: hasil AK sudah divalidasi
            if (
                in_array(PengajuanAkreditasi::STATUS_AK_SELESAI, $statuses) ||
                in_array(PengajuanAkreditasi::STATUS_AK_DILAPORKAN, $statuses)
            ) {
