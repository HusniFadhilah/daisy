<?php
// app/Http/Controllers/UPPS/PelaporanAKController.php
...
{
    /**
     * Display list of pelaporan hasil AK
     */
    public function index(Request $request)
    {
        ...
        return view('upps.pelaporan-ak.index', compact(
            'pengajuans',
            'stats',
            'tahunList'
        ));
    ...
    /**
     * Show detail pelaporan hasil AK
     */
    public function show($id)
    {
        ...
        return view('upps.pelaporan-ak.show', compact('pengajuan'));
    }
    ...
    private function calculateStatistics($studyProgramIds): array
    {
        ...
        foreach ($logsByPengajuan as $pengajuanId => $pengajuanLogs) {
            ...
            // Tervalidasi: penilaian AK sudah selesai dan tervalidasi
            if (in_array(PengajuanAkreditasi::STATUS_AK_SELESAI, $statuses)) {
                $stats['tervalidasi']++;
            }

            // Dilaporkan: hasil AK sudah dilaporkan
