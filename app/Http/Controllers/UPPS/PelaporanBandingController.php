<?php
// app/Http/Controllers/UPPS/PelaporanBandingController.php
...
class PelaporanBandingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = PengajuanAkreditasi::with([
            ...
            'asesmen.asesorALBanding',
            'asesmen.beritaAcaraALBanding' => function ($q) {
        ...
        return view('upps.pelaporan-banding.index', compact(
            'pengajuans',
            'stats',
            'tahunList'
        ));
    ...
    public function show($id)
    {
        ...
        return view('upps.pelaporan-banding.show', compact('pengajuan'));
    }
