...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Kirim surat penerimaan ke PS yang telah mengajukan permohonan akreditasi</p>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Daftar Surat Penerimaan Permohonan Akreditasi</h5>
                        <div>
                ...
                <div class="card-body p-0">
                                ...
                                <tr class="{{ $isUrgent ? 'table-warning' : '' }}">
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-warning">
                                            <i class="bi bi-hourglass-split"></i> Belum Terkirim
                                        </span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('de.penerimaan-permohonan.show', $pengajuan->id) }}" class="btn btn-info action-btn" title="{{ $suratPenerimaan ? 'Lihat Detail' : 'Kirim Surat Penerimaan' }}">
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mt-3">
                            ...
                            @else
                            Tidak ada permohonan yang perlu surat penerimaan
                            @endif
                        </p>
                        @if(request()->filled('search') || request()->filled('status_penerimaan'))
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">
                    <i class="bi bi-info-circle"></i> Panduan Penerimaan Permohonan Akreditasi
                </h5>
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li class="mb-2">
                        <strong>Identifikasi permohonan yang perlu surat penerimaan</strong>
                        <ul>
                            <li>Permohonan dengan status "Surat Permohonan Diterima"</li>
                            <li>Belum memiliki surat penerimaan</li>
                        </ul>
                    </li>
                    <li class="mb-2">
                        <strong>Persiapkan surat penerimaan</strong>
                        <ul>
                            <li>Format: PDF</li>
                            <li>Maksimal ukuran: 5MB</li>
                            <li>Nomor surat format: XXX/LAM-DEPILaR/SP/YYYY</li>
                        </ul>
                    </li>
                    <li class="mb-2">
                        <strong>Upload surat penerimaan</strong>
                        <ul>
                            <li>Klik tombol <span class="badge bg-primary"><i class="bi bi-send"></i></span> pada permohonan</li>
                            <li>Isi nomor dan tanggal surat</li>
                    ...
                    <li class="mb-2">
                        ...
                        <ul>
                            <li>Sistem akan mengirim email ke program studi</li>
                            <li>Program studi dapat mengunduh surat penerimaan</li>
                        </ul>
                    </li>
                </ol>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Tips:</strong>
                    <ul class="mb-0">
                        <li>Prioritaskan permohonan dengan indikator merah (sudah >3 hari)</li>
                        <li>Pastikan nomor dan tanggal surat sudah benar sebelum upload</li>
                        <li>Surat dapat dihapus dan diupload ulang jika ada kesalahan</li>
                    </ul>
                </div>
            </div>
