    ...
    <div class="row mb-4">
                ...
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="opacity-75">Siap atau sudah dilaporkan</small>
                        </div>
                ...
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="opacity-75">Menunggu upload dokumen</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
                ...
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="opacity-75">Pelaporan selesai</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-1 opacity-75">Punya Sertifikat</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $stats['punya_sertifikat'] }}</h2>
                            <small class="opacity-75">Sertifikat sudah terbit</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
