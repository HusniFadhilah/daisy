...
<div class="container-fluid py-3">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h4 class="mb-1">
                <i class="bi bi-patch-check"></i> Validasi AK Banding
            </h4>
            <p class="text-muted mb-0">Monitor proses validasi asesmen kecukupan banding</p>
        </div>
        <div>
...
<div id="tableContainer" class="position-relative">
    ...
    <div id="tableContent">
        @include('de.banding.validasi-ak-banding.components.table-content', ['pengajuans' => $pengajuans])
    </div>
</div>
</div>
...
<script>
    ...
    function applyFilters() {
        ...
        // Fetch data
        fetch(`{{ route('de.banding.validasi-ak-banding') }}?${params.toString()}`, {
                headers: {
