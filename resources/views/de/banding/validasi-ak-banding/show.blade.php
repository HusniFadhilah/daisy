...
@section('title', 'Detail Validasi AK Banding - ' . $pengajuan->nomor_pengajuan)
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('de.banding.validasi-ak-banding') }}">Validasi AK Banding</a></li>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h5 class="mb-1">
                <i class="bi bi-patch-check"></i> Detail Validasi AK Banding
            </h5>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('de.banding.validasi-ak-banding') }}" class="btn btn-secondary">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            ...
            <div class="alert alert-info alert-permanent">
                ...
                Asesor dan Validator sedang ditugaskan untuk melakukan penilaian dan validasi AK Banding. <br>Mohon pantau progres penilaian secara berkala
            </div>
            ...
            <div class="alert alert-info alert-permanent">
                ...
                Asesor AK sedang melakukan penilaian AK banding. Mohon pantau progres penilaian secara berkala
            </div>
            @elseif($log?->status_to === \App\Models\PengajuanAkreditasi::STATUS_AK_BANDING_ON_VALIDATION)
            ...
            <div class="alert alert-success alert-permanent">
                ...
                <strong>Validasi AK Banding Selesai</strong><br>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                return $aur->role_selected->name === 'asesor_banding' ? 0 : 1;
                                }) as $index => $assignment)
                                @php
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mt-3 mb-0">Belum ada penugasan asesor banding atau validator</p>
                    </div>
                    @endif
                </div>
            </div>

            <!-- Informasi Validasi AK Banding -->
            <div class="card mb-4">
                <div class="card-header bg-secondary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-info-circle"></i> Informasi Validasi AK Banding
                    </h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                            ...
                            <td>
                                : {{ $pengajuan->tanggal_ak_banding_mulai
                                    ? $pengajuan->tanggal_ak_banding_mulai->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <th>Tanggal Validasi AK Banding</th>
                            <td>
                                : {{ $pengajuan->tanggal_validasi_ak_banding
                                    ? $pengajuan->tanggal_validasi_ak_banding->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                : {{ $pengajuan->tanggal_ak_banding_selesai
                                    ? $pengajuan->tanggal_ak_banding_selesai->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <th>Status Validasi AK Banding</th>
                            <td>: {!! $pengajuan->getCustomBadgeLastStatus('validasi_ak_banding', 'de', 'label_long_for') !!}</td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-4">
                <div class="card-header bg-info text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-calendar-range"></i> Jadwal AK Banding
                    </h5>
                </div>
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        @if($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_mulai)
                        <tr>
                            <th class="text-muted" width="45%">Tanggal Mulai</th>
                            <td>: <strong>{{ \Carbon\Carbon::parse($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_mulai)->locale('id')->translatedFormat('d M Y') }}</strong></td>
                        </tr>
                        @endif
                        @if($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_selesai)
                        <tr>
                            <th class="text-muted">Tanggal Selesai</th>
                            <td>: <strong>{{ \Carbon\Carbon::parse($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_selesai)->locale('id')->translatedFormat('d M Y') }}</strong></td>
                        </tr>
                        @endif
                        @if($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_mulai && $pengajuan->asesmen->asesmenKecukupanBanding->tanggal_selesai)
                        <tr>
                            <th class="text-muted">Durasi</th>
                            <td>:
                                @php
                                $start = \Carbon\Carbon::parse($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_mulai);
                                $end = \Carbon\Carbon::parse($pengajuan->asesmen->asesmenKecukupanBanding->tanggal_selesai);
