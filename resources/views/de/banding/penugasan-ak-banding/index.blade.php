{{-- resources\views\de\banding\penugasan-ak-banding\index.blade.php --}}
@extends('layouts.template.app')

@section('title', 'Penugasan Asesmen Kecukupan (AK) Banding')
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Penugasan Asesor AK Banding</li>
        </ol>
    </nav>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h4 class="mb-1">
                <i class="bi bi-person-check"></i> Penugasan Asesor AK Banding
            </h4>
            <p class="text-muted mb-0">Tugaskan asesor banding & validator untuk melakukan asesmen kecukupan banding</p>
        </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 mb-4">
        <div class="col mb-3">
            <x-stat-card title="Total Permohonan" :value="$stats['total']" description="Permohonan akreditasi PS yang telah memasuki tahap AK banding" icon="clipboard-check" gradient="linear-gradient(135deg, #667eea 0%, #764ba2 100%)" />
        </div>
        ...
        <div class="col mb-3">
            <x-stat-card title="Selesai" :value="$stats['selesai']" description="AK banding telah selesai" icon="check-circle" gradient="linear-gradient(135deg, #11998e 0%, #38ef7d 100%)" />
        </div>
    </div>
...
<div class="col-lg-12">
    <div class="position-relative">
        ...
        <div id="tableContainer">
            @include('de.banding.penugasan-ak-banding.components.table-content', ['pengajuans' => $pengajuans])
        </div>
    </div>
</div>
</div>
...
<script>
    ...
    async function loadTable(params = {}) {
        ...
        try {
            ...
            const response = await fetch(`{{ route('de.banding.penugasan-ak-banding') }}?${queryString}`, {
                method: 'GET'
                , headers: {
