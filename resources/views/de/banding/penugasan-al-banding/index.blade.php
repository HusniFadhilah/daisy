...
@section('title', 'Penugasan Asesmen Lapangan Banding (AL) Banding')
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Penugasan Asesor AL Banding</li>
        </ol>
    </nav>
    <!-- Page Header -->
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h4 class="mb-1">
                <i class="bi bi-building"></i> Penugasan Asesor AL Banding
            </h4>
            <p class="text-muted mb-0">Tugaskan asesor untuk melakukan Asesmen Lapangan Banding</p>
        </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 mb-4">
        <div class="col mb-3">
            <x-stat-card title="Total Permohonan" :value="$stats['total']" description="Permohonan akreditasi PS yang telah memasuki tahap AL Banding" icon="clipboard-check" gradient="linear-gradient(135deg, #667eea 0%, #764ba2 100%)" />
        </div>

        <div class="col mb-3">
            <x-stat-card title="Siap AL Banding" :value="$stats['siap_al']" description="AK Banding selesai, siap visitasi, perlu menugaskan asesor AL Banding" icon="exclamation-triangle" gradient="linear-gradient(135deg, #ee0979 0%, #ff6a00 100%)" />
        </div>
        ...
        <div class="col mb-3">
            <x-stat-card title="Selesai" :value="$stats['selesai']" description="AL Banding telah selesai" icon="check-circle" gradient="linear-gradient(135deg, #11998e 0%, #38ef7d 100%)" />
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="position-relative">
                ...
                <div id="tableContainer">
                    @include('de.banding.penugasan-al-banding.components.table-content', ['pengajuans' => $pengajuans])
                </div>
            </div>
        </div>
    </div>
