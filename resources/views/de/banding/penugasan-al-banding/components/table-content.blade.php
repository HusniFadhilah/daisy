<div class="card">
    <div class="card-header bg-light d-flex justify-content-between align-items-center">
        <h6 class="mb-0">
            <i class="bi bi-table"></i> Daftar Penugasan Asesor AL Banding
        </h6>
    ...
    <div class="card-body p-0">
            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th width="16%">Status Penugasan AL Banding</th>
                        <th width="16%">Tanggal Penugasan AL Banding</th>
                ...
                <tbody>
                    ...
                    // Get jadwal
                    $jadwal = $pengajuan->asesmen?->asesmenLapanganBanding;
                    ...
                    <tr>
                        ...
                        <td>
                            {!! $pengajuan->getCustomBadgeLastStatus('penugasan_asesor_al_banding','de','label_short_for') !!}
                        </td>
                        <td>
                            @if($pengajuan->tanggal_penugasan_asesor_al_banding)
                            <small>{{ $pengajuan->tanggal_penugasan_asesor_al_banding->locale('id')->translatedFormat('d M Y') }}</small>
                            <br>
                            <small class="text-muted">
                                {{ $pengajuan->tanggal_penugasan_asesor_al_banding->diffForHumans() }}
                            </small>
                            @else
                        ...
                        <td class="text-center">
                            <a href="{{ route('de.banding.penugasan-al-banding.show', $pengajuan->id) }}" class="btn btn-sm btn-primary" title="Lihat Detail & Tugaskan">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted mt-3 mb-0">Tidak ada permohonan akreditasi yang siap untuk AL banding</p>
        </div>
        @endif
    </div>
