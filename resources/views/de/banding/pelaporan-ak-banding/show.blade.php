...
@section('title', 'Detail Pelaporan AK Banding - ' . $pengajuan->nomor_pengajuan)
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('de.banding.pelaporan-ak-banding') }}">Monitor Pelaporan AK Banding</a></li>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h5 class="mb-1">
                <i class="bi bi-file-earmark-bar-graph"></i> Detail Pelaporan AK Banding
            </h5>
            <small class="text-muted">{{ $pengajuan->nomor_pengajuan }}</small>
        </div>
        <a href="{{ route('de.banding.pelaporan-ak-banding') }}" class="btn btn-secondary">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            ...
            <!-- Status Alert -->
            @if($log?->status_to === \App\Models\PengajuanAkreditasi::STATUS_AK_BANDING_SELESAI)
            <div class="alert alert-warning alert-permanent">
                <i class="bi bi-clock-history"></i>
                <strong>Menunggu Pelaporan</strong><br>
                Validasi AK banding telah selesai. Validator perlu melaporkan hasil asesmen kecukupan banding untuk melanjutkan proses ke tahap berikutnya
            </div>
            @elseif($log?->status_to === \App\Models\PengajuanAkreditasi::STATUS_AK_BANDING_DILAPORKAN)
            <div class="alert alert-success alert-permanent">
                <i class="bi bi-check-circle"></i>
                <strong>Pelaporan AK Banding Selesai</strong><br>
                Hasil asesmen kecukupan banding telah dilaporkan pada {{ $statusPelaporan['reported_at'] ? \Carbon\Carbon::parse($statusPelaporan['reported_at'])->locale('id')->translatedFormat('d M Y H:i') : '-' }}
            </div>
            @endif
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="bi bi-file-earmark-pdf"></i> Dokumen Laporan AK Banding
                    </h5>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="text-center py-5">
                        ...
                        <small class="text-muted">Validator perlu mengupload laporan hasil AK banding</small>
                    </div>
                    @endif
                </div>
            </div>

            <!-- Informasi Pelaporan AK Banding -->
            <div class="card">
                <div class="card-header bg-secondary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-info-circle"></i> Informasi Pelaporan AK Banding
                    </h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>Status Pelaporan AK Banding</th>
                            <td>: {!! $pengajuan->getCustomBadgeLastStatus('pelaporan_ak_banding', 'de', 'label_long_for') !!}</td>
                        </tr>
                    </table>
                </div>
            </div>
