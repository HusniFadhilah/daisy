...
@section('title', 'Monitor Pelaporan AK Banding')
...
<div class="container-fluid py-3">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h4 class="mb-1">
                <i class="bi bi-file-earmark-bar-graph"></i> Pelaporan AK Banding
            </h4>
            <p class="text-muted mb-0">Monitor pelaporan AK banding</p>
        </div>
        <div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mb-4">
        <div class="col mb-3">
            <x-stat-card title="Total AK Selesai" :value="$stats['total']" description="Validasi selesai" icon="clipboard-check" gradient="linear-gradient(135deg, #667eea 0%, #764ba2 100%)" />
        </div>
    ...
    <div class="d-flex align-items-center mb-4">
        <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#modalKirimReminderAKBanding">
...
<div id="tableContainer" class="position-relative">
    ...
    <div id="tableContent">
        @include('de.banding.pelaporan-ak-banding.components.table-content', ['pengajuans' => $pengajuans])
    </div>
</div>
</div>

<x-modal-kirim-reminder-pelaporan modal-id="modalKirimReminderAKBanding" form-action="{{ route('de.banding.pelaporan-ak-banding.kirim-reminder') }}" title="Kirim Pengingat Pelaporan AK Banding" :assignments="$pendingReminderAssignments" :count-pending="$countPendingReminderAssignments" item-description="Belum upload laporan validasi AK Banding" />
...
<script>
    ...
    function applyFilters() {
        ...
        // Fetch data
        fetch(`{{ route('de.banding.pelaporan-ak-banding') }}?${params.toString()}`, {
                headers: {
