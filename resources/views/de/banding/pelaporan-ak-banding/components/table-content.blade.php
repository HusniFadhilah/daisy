<div class="card">
    <div class="card-header bg-light d-flex justify-content-between align-items-center">
        <h6 class="mb-0">
            <i class="bi bi-table"></i> Daftar Pelaporan AK Banding
        </h6>
    ...
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    $isReported = $lastStatus === \App\Models\PengajuanAkreditasi::STATUS_AK_BANDING_DILAPORKAN;
                    ...
                    'class' => 'warning',
                    'icon' => 'clock',
                    'text' => ($lastStatus === \App\Models\PengajuanAkreditasi::STATUS_AK_BANDING_SELESAI)
                    ? 'Validasi Selesai'
                    : 'Unknown'
                    ];
                    }
                    ...
                    $labelTanggal = $isReported ? 'Dilaporkan' : (($lastStatus === \App\Models\PengajuanAkreditasi::STATUS_AK_BANDING_SELESAI) ? 'Validasi Selesai' : null);
                    @endphp
                    <tr>
                        ...
                        <td>
                            {!! $pengajuan->getCustomBadgeLastStatus('pelaporan_ak_banding', 'de', 'label_short_for') !!}
                        </td>
                        <td>
                            <small>{{ $tanggalTampil }}</small>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('de.banding.pelaporan-ak-banding.show', $pengajuan->id) }}" class="btn btn-sm btn-primary" title="Lihat Detail">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted mt-3 mb-0">Tidak ada data pelaporan AK Banding</p>
        </div>
        @endif
    </div>
