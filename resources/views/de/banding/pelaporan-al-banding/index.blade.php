...
@section('title', 'Monitor Pelaporan AL Banding')
...
<div class="container-fluid py-3">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h4 class="mb-1">
                <i class="bi bi-journal-text"></i> Pelaporan AL Banding
            </h4>
            <p class="text-muted mb-0">Monitor pelaporan AL banding setelah validasi selesai</p>
        </div>
        <div>
    ...
    <div class="d-flex align-items-center mb-4">
        <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#modalKirimReminderALBanding">
...
<div id="tableContainer" class="position-relative">
    ...
    <div id="tableContent">
        @include('de.banding.pelaporan-al-banding.components.table-content', ['pengajuans' => $pengajuans])
    </div>
</div>
</div>

<x-modal-kirim-reminder-pelaporan modal-id="modalKirimReminderALBanding" form-action="{{ route('de.banding.pelaporan-al-banding.kirim-reminder') }}" title="Kirim Pengingat Pelaporan AL Banding" :assignments="$pendingReminderAssignments" :count-pending="$countPendingReminderAssignments" item-description="Belum upload laporan AL Banding" />
...
<script>
    ...
    function applyFilters() {
        ...
        // Fetch data
        fetch(`{{ route('de.banding.pelaporan-al-banding') }}?${params.toString()}`, {
                headers: {
