...
@section('title', 'Pelaksanaan & Monitoring AL Banding')
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Pelaksanaan AL Banding & Berita Acara</li>
        </ol>
    </nav>
    <!-- Page Header -->
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h4 class="mb-1">
                <i class="bi bi-geo-alt"></i> Pelaksanaan AL Banding & Berita Acara
            </h4>
            <p class="text-muted mb-0">Monitor pelaksanaan asesmen lapangan banding</p>
        </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 mb-4">
        ...
        <div class="col mb-3">
            <x-stat-card title="Sedang Visitasi" :value="$stats['sedang_visitasi']" description="Asesor banding sedang proses surveillance" icon="people" gradient="linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)" />
        </div>
        ...
        <div class="col mb-3">
            <x-stat-card title="Selesai" :value="$stats['selesai']" description="AL banding dilaporkan" icon="check-circle" gradient="linear-gradient(135deg, #11998e 0%, #38ef7d 100%)" />
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="position-relative">
                ...
                <div id="tableContainer">
                    @include('de.banding.pelaksanaan-al-banding.components.table-content', ['pengajuans' => $pengajuans])
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    async function loadTable(params = {}) {
        ...
        try {
            ...
            const response = await fetch(`{{ route('de.banding.pelaksanaan-al-banding') }}?${queryString}`, {
                method: 'GET'
                , headers: {
