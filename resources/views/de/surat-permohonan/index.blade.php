...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="bi bi-envelope"></i> Surat Permohonan dari Program Studi</h4>
            <p class="text-muted mb-0">Kelola surat permohonan akreditasi dari program studi</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-2 opacity-75">Total Permohonan Akreditasi PS</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-2 fw-bold">{{ $stats['total'] }}</h2>
                            <small class="opacity-75">Total permohonan akreditasi aktif saat ini</small>
                        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-1 opacity-75">Menunggu Surat</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $stats['menunggu'] }}</h2>
                            <small class="opacity-75">Pengingat sudah dikirim, tetapi PS belum mengajukan surat permohonan</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #8ebb0aff 0%, #c0c30dff 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-1 opacity-75">Sudah Dikirim oleh PS</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-1 opacity-75">Sudah Ditanggapi</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
        ...
        <div class="col-lg-9">
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Daftar Permohonan Akreditasi PS</h5>
                        <div>
