...
<div class="container-fluid py-3">
    ...
    <div class="d-flex align-items-center mb-4">
        <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#modalKirimReminderAL">
...
<x-modal-kirim-reminder-pelaporan modal-id="modalKirimReminderAL" form-action="{{ route('de.pelaporan-al.kirim-reminder') }}" title="Kirim Pengingat Pelaporan AL" :assignments="$pendingReminderAssignments" :count-pending="$countPendingReminderAssignments" item-description="Belum upload laporan AL" />
