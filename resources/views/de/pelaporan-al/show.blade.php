            ...
            <div class="col-lg-8 mb-4">
                ...
                @if ($log?->status_to === \App\Models\PengajuanAkreditasi::STATUS_AL_SELESAI)
                    <div class="alert alert-warning alert-permanent">
                        ...
                        Asesmen lapangan telah selesai. Validator perlu melaporkan hasil visitasi untuk melanjutkan proses
                        ke tahap berikutnya
                    </div>
                @elseif($log?->status_to === \App\Models\PengajuanAkreditasi::STATUS_AL_DILAPORKAN)
                    <div class="alert alert-success alert-permanent">
                        ...
                        Hasil asesmen lapangan telah dilaporkan pada
                                        ...
                                        @foreach ($laporanDocuments as $index => $doc)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('storage.laporan-al.preview', ['pengajuan' => $pengajuan->id, 'filename' => basename($doc->path)]) }}"
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        @php
                            $validators =
                                $pengajuan->asesmen?->asesmenUserRoles->filter(function ($aur) {
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex align-items-center p-3 bg-light rounded">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <br>
                                                <span
                                                    class="badge bg-success mt-1">{{ $validator->role_selected->alias }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
