    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #ee0979 0%, #ff6a00 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-1 opacity-75">Belum Ditugaskan</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-2 fw-bold">{{ $stats['belum_ditugaskan'] }}</h2>
                            <small class="opacity-75">Perlu ditugaskan asesor/validator</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
                ...
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="opacity-75">Sedang proses asesmen</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
                ...
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="opacity-75">AK telah selesai</small>
                        </div>
                        <div class="stat-icon" style="background: rgba(255,255,255,0.2);">
