...
<div class="alert alert-info alert-permanent alert-dismissible mb-3">
    ...
    Silahkan finalisasi Hasil dan Berita Acara Surveillance Banding setelah Anda mengupload file Hasil dan Berita Acara Surveillance Banding (PDF). Dengan mengklik tombol "Finalisasi Berita Acara" di bawah ini
</div>
@else
<div class="alert alert-success alert-permanent alert-dismissible mb-3">
    <i class="bi bi-check-circle me-2"></i>
    Hasil dan Berita Acara Surveillance Banding telah difinalisasi. Terima kasih atas partisipasi Anda dalam menjadi Asesor di Asesmen ini.
</div>
@endif
...
<div class="card shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
            <i class="bi bi-folder2-open"></i> Hasil dan Berita Acara Surveillance Banding
        </h5>
        @if(!$isFinalized)
    ...
    <div class="card-body">
        ...
        <div id="uploadSection" style="display: none;">
            <div class="alert alert-info alert-permanent">
                ...
                Upload file Hasil dan Berita Acara Surveillance Banding (PDF).
                Format file yang harus ditanda-tangani dapat didownload pada
                <a href="{{ route('banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'personal']) }}" class="alert-link">
                    link ini
                </a>.
            </div>

            <form id="uploadForm" action="{{ route('banding.berkas.documents.upload', $asesmen->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-2 align-items-end">
                    <div class="col-md-8">
                        <label class="form-label fw-semibold">Upload file Hasil dan Berita Acara Surveillance Banding (PDF)</label>
...
<script>
    ...
    const listUrl = "{{ route('banding.berkas.documents.list', $asesmen->id) }}";
    const finalizeUrl = "{{ route('banding.berkas.documents.finalize', $asesmen->id) }}";
