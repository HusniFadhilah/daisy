...
@section('title', 'Penilaian Banding - ' . $asesmen->name)
...
<div class="container-fluid py-3">
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <a href="{{ route('banding.berkas.show', ['idAsesmen' => $asesmen->id, 'step' => 1]) }}" class="text-decoration-none d-flex align-items-center gap-2">
                    <span class="step-circle {{ $step === 1 ? 'active' : 'done' }}">1</span>
                    <div>
                        <div class="fw-bold {{ $step === 1 ? '' : 'text-muted' }}">Penilaian Surveillance Banding</div>
                    </div>
                </a>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h3 class="mb-1">Penilaian Surveillance Banding</h3>
            ...
            <div class="row align-items-center my-2">
                <div class="col-12 mb-md-0">
                    ...
                    <div class="alert alert-success alert-permanent alert-dismissible mb-3">
                        ...
                        <strong>Penilaian Disetujui!</strong> Penilaian Anda pada tahap Surveillance Banding telah divalidasi dan disetujui oleh LAMDEPILAR.
                        {{-- Silahkan unduh file Hasil penilaian lengkap di <a href="{{ route('banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'personal']) }}" class="alert-link">link ini</a>. Tanda tangani, lalu upload ulang di step ke-2 (Hasil dan berita acara Surveillance Banding) di halaman <a href="{{ route('banding.berkas.documents.page', ['id' => $asesmen->id]) }}" class="alert-link">berikut ini</a>. --}}
                    </div>
                    @endif
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
                        ...
                        <div class="btn-group flex-wrap w-md-100 w-md-auto">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!-- Download Templat -->
                                <li>
                                    <a class="dropdown-item" href="{{ route('banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'template']) }}" id="btnDownloadTemplate">
                                ...
                                {{-- <li>
                                    <a class="dropdown-item btnDownloadData" data-mode="full" href="{{ route('banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'full']) }}">
                                ...
                                <li>
                                    <a class="dropdown-item btnDownloadData" data-mode="personal" href="{{ route('banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'personal']) }}">
    ...
    @include('asesmen.banding.components.heatmap-matrix')
    ...
    @endforeach
    @elseif($step === 2)
    @include('asesmen.banding.components.berita-acara')
    @endif
</div>
