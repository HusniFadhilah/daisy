{{-- resources/views/asesmen/banding/berkas/document.blade.php --}}
@extends('layouts.template.app')

@section('title', 'Upload Berita Acara Surveillance Banding - ' . $asesmen->name)
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('banding.berkas') }}">Berkas Surveillance Banding</a></li>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                <div>
                    <h4 class="mb-1">
                        <i class="bi bi-file-earmark-pdf"></i> Upload Berita Acara Surveillance Banding
                    </h4>
        ...
        <div class="col-lg-8">
            ...
            <div class="card {{ !$canUpload ? 'border-secondary' : '' }}">
                ...
                <div class="card-body">
                    ...
                    @else
                    <form method="POST" action="{{ route('banding.berkas.documents.upload', ['id' => $asesmen->id]) }}" enctype="multipart/form-data" id="uploadForm">
                        @csrf
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('banding.berkas.documents.preview', ['id' => $asesmen->id, 'docId' => $doc->id]) }}" class="btn btn-outline-primary" target="_blank" title="Lihat File">
                                                <i class="bi bi-eye"></i>
                                            </a>

                                            {{-- ✅ Tombol hapus hanya muncul jika user adalah uploader --}}
                                            @if($isUploader && $doc->uploaded_by == Auth::id())
                                            <button type="button" class="btn btn-outline-danger btn-delete-doc" data-doc-id="{{ $doc->id }}" data-doc-name="{{ $doc->title }}" data-url="{{ route('banding.berkas.documents.delete', ['id' => $asesmen->id, 'docId' => $doc->id]) }}" title="Hapus">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ol class="mb-4 small ps-3">
                        <li class="mb-2">
                            Download format berita acara yang telah terisi dari proses penilaian Banding
                            <div class="my-2 text-center">
                                <a href="{{ route('banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'personal']) }}" class="btn btn-sm btn-outline-primary">
            ...
            <div class="card mt-3">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">
                        <i class="bi bi-people"></i> Tim Asesor Banding
                    </h6>
                </div>
                <div class="card-body">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (uploadForm) {
            uploadForm.addEventListener('submit', function(e) {
                ...
                fetch("{{ route('banding.berkas.documents.upload', ['id' => $asesmen->id]) }}", {
                        method: 'POST'
                        , body: formData
                        , headers: {
        ...
        if (btnFinalize) {
            btnFinalize.addEventListener('click', async function() {
                ...
                fetch("{{ route('banding.berkas.documents.finalize', ['id' => $asesmen->id]) }}", {
                        method: 'POST'
                        , headers: {
                            'X-CSRF-TOKEN': "{{ csrf_token() }}"
                            , 'Accept': 'application/json'
                    ...
                    .then(function(data) {
                        if (data.success) {
                            ...
                            window.location.href = "{{ route('banding.berkas') }}";
                        } else {
