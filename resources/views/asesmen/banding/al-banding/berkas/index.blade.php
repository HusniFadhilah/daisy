                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-stack">
                                    ...
                                    <a href="{{ route('al_banding.berkas.export', ['idAsesmen'=>$asesmen->id,'mode'=>'template']) }}" class="btn btn-outline-primary btn-sm btn-fixed-sm" target="_blank">
                                        <i class="bi bi-file-earmark-excel me-1"></i>
                                        Download Templat Penilaian AL
                                    </a>
                            ...
                            <td class="text-center">
                                <div class="btn-stack">
                                    ...
                                    @else
                                    <a href="{{ route('al_banding.berkas.show',$asesmen->id) }}" class="btn btn-primary btn-fixed" @if($statusInfo['button_disabled']) disabled @endif>
                                    ...
                                    <a href="{{ route('al_banding.berkas.upload-excel', $asesmen->id) }}" class="btn btn-info btn-fixed" @if($statusInfo['button_disabled']) disabled @endif>
                                        <i class="bi bi-upload"></i>
                                        Penilaian dengan Form Excel
                                    </a>

                                    <a href="{{ route('al_banding.berkas.documents.page', ['id' => $asesmen->id]) }}" class="btn btn-success btn-fixed" @if($statusInfo['button_disabled']) disabled @endif>
                            ...
                            <td class="text-center">
                                <div class="btn-stack mb-4">
                                    <a href="{{ route('al_banding.berkas.lha-asesor.page', ['idAsesmen' => $asesmen->id]) }}" class="btn btn-blue btn-fixed-sm" @if($statusInfo['button_disabled']) disabled @endif>
                                        <i class="bi bi-file-earmark-text me-1"></i>
                                        Laporan Hasil Asesmen
                                    </a>
                                </div>
                                <div class="btn-stack">
                                    <a href="{{ route('al_banding.berkas.ringkasan-asesor.page', ['idAsesmen' => $asesmen->id]) }}" class="btn btn-dark btn-fixed-sm" @if($statusInfo['button_disabled']) disabled @endif>
                                        <i class="bi bi-file-earmark-text me-1"></i>
