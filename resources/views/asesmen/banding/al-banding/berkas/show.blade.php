...
<div class="container-fluid py-3">
    ...
    @include('asesmen.banding.al-banding.components.heatmap-matrix')
            ...
            <div id="collapse-kriteria-{{ $kriteria->id }}" class="accordion-collapse collapse kriteria-collapse" aria-labelledby="heading-kriteria-{{ $kriteria->id }}" data-bs-parent="#accordionKriteria">
                <div class="card-body">
                    ...
                    <div class="accordion accordion-elemen" id="accordionElemen-{{ $kriteria->id }}">
                        ...
                        $penilaianElemenAlBanding = $elemen->penilaianElemenAlBanding->first(); // Assuming relation exists
                        $hasPenilaian = $penilaianElemenAlBanding && $penilaianElemenAlBanding->skor !== null;
                        $needsRevisionElemen = $penilaianElemenAlBanding && $penilaianElemenAlBanding->status_validasi === 'revision_required';
                                ...
                                <div class="penilaian-form-wrapper mb-4">
                                    <div class="card border-{{ $needsRevisionElemen ? 'warning' : ($hasPenilaian ? 'success' : 'warning') }}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($needsRevisionElemen)
                                            @php
                                            $preferensiSkor = $penilaianElemenAlBanding->preferensi_skor;
                                            @endphp
                                            <div class="alert alert-warning alert-permanent alert-dismissible mb-3">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        ...
                                                        <p class="mb-2"><strong>"{{ $penilaianElemenAlBanding->catatan_validator }}"</strong></p>
                                                    </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6">
                                                        <small class="text-muted">
                                                            <i class="bi bi-person"></i> <strong>Validator:</strong> {{ $penilaianElemenAlBanding->validator->name ?? 'N/A' }}
                                                        </small>
                                                    </div>
                                                    <div class="col-md-6 text-end">
                                                        <small class="text-muted">
                                                            <i class="bi bi-clock"></i> <strong>Tanggal:</strong> {{ \App\Libraries\Date::tglWaktu($penilaianElemenAlBanding->validated_at) }}
                                                        </small>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <select class="form-select skor-select" name="skor" required>
                                                            ...
                                                            @foreach ($jenjangs as $jenjang)
                                                            <option value="{{ $jenjang->skor }}" @if($hasPenilaian && $penilaianElemenAlBanding->skor == $jenjang->skor) selected @endif style="background:{{ $jenjang->color }}; color:{{ \App\Models\JenjangPenilaian::textColorByBg($jenjang->color) }}">
                                                                {{ $jenjang->skor }} - {{ $jenjang->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-12 komentar-section">
                                                        ...
                                                        <textarea class="form-control komentar-textarea" name="komentar" rows="15" placeholder="Berikan justifikasi dan analisis penilaian berdasarkan seluruh indikator di bawah ini..." required>{{ $hasPenilaian ? $penilaianElemenAlBanding->komentar : '' }}</textarea>
                                                        <small class="text-muted">
                                                            <i class="bi bi-info-circle me-1"></i>
                                                            <span class="char-count">{{ $hasPenilaian ? strlen($penilaianElemenAlBanding->komentar) : 0 }}</span> karakter
                                                        </small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-2">
                                                    <div class="save-status text-muted small d-flex align-items-center flex-wrap">
                                                        ...
                                                        <span class="status-text">
                                                            @if($hasPenilaian)
                                                            Tersimpan pada {{ \App\Libraries\Date::tglWaktu($penilaianElemenAlBanding->updated_at) }}
                                                            @else
                                                            Belum ada penilaian
                                                            @endif
                                                        </span>
    ...
    @endforeach
    @elseif($step === 2)
    @include('asesmen.banding.al-banding.components.berita-acara')
    @endif
</div>
