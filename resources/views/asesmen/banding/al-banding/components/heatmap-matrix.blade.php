    ...
    <div class="card-header bg-white border-bottom">
        <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
            ...
            <div class="btn-group btn-group-sm flex-wrap">
                {{-- <button type="button" class="btn btn-outline-info" id="btnViewComparison" data-id-asesmen="{{ $asesmen->id }}" data-jenis-asesmen="al" title="Lihat Perbandingan Penilaian Antar Asesor Banding">
        ...
        <div class="matrix-wrapper" style="overflow-x: auto; overflow-y: auto; max-height: 600px;">
            <table class="matrix-table" id="heatmapMatrix">
                ...
                <tbody>
                    ...
                    @php
                    // Get penilaianElemenAlBanding for this elemen (not indikator!)
                    ...
                    <tr>
                        ...
                        {{-- Kolom Pemenuhan --}}
                        <td class="matrix-cell" data-elemen-id="{{ $elemen->id }}" data-kriteria-id="{{ $kriteria->id }}" data-col="pemenuhan" style="background-color: {{ $hasPenilaian ? $penilaianElemenAlBanding->skor == 4 ? '#e0e0e0' : \App\Models\JenjangPenilaian::getSkorColor($penilaianElemenAlBanding->skor) : '#e0e0e0' }}">
                        </td>

                        {{-- Kolom Pelampauan --}}
                        <td class="matrix-cell" data-elemen-id="{{ $elemen->id }}" data-kriteria-id="{{ $kriteria->id }}" data-col="pelampauan" style="background-color: {{ $hasPenilaian ? $penilaianElemenAlBanding->skor == 4 ? \App\Models\JenjangPenilaian::getSkorColor(4) : '#e0e0e0' : '#e0e0e0' }}">
                        </td>
                    </tr>
                    @endforeach
                    @endforeach
