            ...
            if (isFirstOpener) {
                ...
                Swal.fire({
                    ...
                    <div class="text-start">
                        <p>
                            Selamat! Anda adalah <strong>asesor banding pertama</strong> yang membuka halaman
                            penilaian AL Banding ini.
                        </p>
                        <div class="alert alert-success text-start mb-3" style="border-left:4px solid #198754;">
                            ...
                            <small>
                                ...
                                <strong>memfinalisasi</strong> penilaian AL Banding ini.
                            </small>
                        </div>
                        <div class="alert alert-warning text-start mb-0" style="border-left:4px solid #ffc107;">
                            <i class="bi bi-people me-2"></i>
                            <strong>Asesor Banding Lain</strong><br>
                            <small>
                                Asesor banding lain dalam tim tetap dapat <em>melihat</em> halaman penilaian,
                ...
                Swal.fire({
                    ...
                    <div class="text-start">
                        <p>
                            Asesor banding <strong>${firstOpenerName ?? 'lain'}</strong> sudah lebih dulu
                            membuka halaman penilaian AL Banding ini dan menjadi <strong>pemegang hak finalisasi</strong>.
                        </p>
                        <div class="alert alert-danger text-start mb-3" style="border-left:4px solid #dc3545;">
                            ...
                            <small>
                                Hanya <strong>${firstOpenerName ?? 'asesor banding pertama'}</strong> yang dapat
                                mengisi, mengupload, dan memfinalisasi penilaian AL Banding ini.
                            </small>
                        </div>
