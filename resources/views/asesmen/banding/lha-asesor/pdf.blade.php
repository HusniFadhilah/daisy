...
<body>
    ...
    <div class="header">
        ...
        <div class="document-title-section">
            <div class="document-title-main">Laporan Surveilance Penanganan Banding</div>
        </div>
    </div>
    ...
    <!-- 2. Proses AL -->
    <div class="section">
        <div class="section-title">II. PROSES ASESMEN LAPANGAN BANDING</div>
        <div class="section-content">{{ $lha->proses_al }}</div>
    </div>

    <!-- 3. Hasil AL -->
    <div class="section">
        <div class="section-title">III. HASIL ASESMEN LAPANGAN BANDING</div>
    ...
    <div class="footer">
        ...
        <div class="footer-date">
            Tanggal Laporan Dibuat: {{ $lha->created_at ? $lha->created_at->locale('id')->isoFormat('D MMMM Y') : now()->locale('id')->isoFormat('D MMMM Y') }}
        </div>

        <!-- Tim Asesor -->
        <div class="footer-team-title">
            Laporan Surveilance Penanganan Banding disusun oleh tim asesor:
        </div>
        ...
        <div class="footer-approval">
            ...
            menyatakan menyetujui Laporan Surveilance Penanganan Banding
        </div>
        @else
