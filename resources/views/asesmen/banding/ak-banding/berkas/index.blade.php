{{-- resources/views/asesmen/banding/ak-banding/berkas/index.blade.php --}}

@extends('layouts.template.app')

@section('title', 'Daftar Berkas Penilaian AK Banding')
    ...
    <div class="welcome-section mb-4">
        <div class="welcome-content">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                <div>
                    <h2 class="mb-1">
                        <i class="bi bi-clipboard-check"></i> Daftar Berkas Penilaian AK Banding
                    </h2>
                    <p class="mb-0 opacity-75">
                        Kelola dan lakukan penilaian asesmen kecukupan banding dari program studi
                    </p>
                </div>
                <div class="text-end">
                ...
                <table class="table table-bordered table-hover align-middle mb-0">
                    <thead class="table-light text-center">
                        <tr>
                            ...
                            <th width="30%">Dokumen AK Banding</th>
                    ...
                    <tbody>
                        ...
                        $assignment = $asesmen->userRoles->where('jenis_asesmen', 'ak_banding')->first();
                        $pengajuan = $asesmen->pengajuan;

                        $suratTugas = $pengajuan?->dokumen
                        ->whereIn('jenis_dokumen', ['surat_tugas_asesor_ak_banding'])
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <div class="d-flex flex-column gap-1 align-items-center">
                                    ...
                                    @if($sp['splitCount'] > 0)
                                    <a href="{{ route('ak_banding.berkas.cek-split', $asesmen->id) }}" target="_blank" class="badge bg-light text-danger border border-danger-subtle text-decoration-none w-100" title="Klik untuk lihat detail split">
                            ...
                            <td class="text-center">
                                <div class="btn-stack">
                                    ...
                                    <div class="border-top pt-2">
                                        <a href="{{ route('ak_banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'template']) }}" class="btn btn-outline-primary btn-sm btn-width-270" target="_blank">
                                            <i class="bi bi-file-earmark-excel me-1"></i>
                                            Download Templat Penilaian AK Banding
                                        </a>
                                    </div>
                            ...
                            <td class="text-center">
                                <div class="btn-stack">
                                    ...
                                    @else
                                    <a href="{{ route('ak_banding.berkas.show', $asesmen->id) }}" class="btn btn-primary btn-sm btn-width-270" @if($statusInfo['button_disabled']) disabled @endif>
                                    ...
                                    <a href="{{ route('ak_banding.berkas.upload-excel', $asesmen->id) }}" class="btn btn-info btn-sm btn-width-270" @if($statusInfo['button_disabled']) disabled @endif>
                                    ...
                                    <div class="border-top pt-2">
                                        ...
                                        <a href="{{ route('ak_banding.berkas.cek-split', ['idAsesmen' => $asesmen->id]) }}" class="btn btn-secondary btn-sm btn-width-270" target="_blank">
                                            <i class="bi bi-eye"></i>
                                            Cek Penilaian / Split
                                        </a>
                                        @endif
