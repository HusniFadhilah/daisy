{{-- resources\views\asesmen\banding\ak-banding\berkas\show.blade.php --}}
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-2">
                                    ...
                                    {{-- <br>Anda dapat melakukan cek split penilaian antar asesor di tombol berikut <a class="btn btn-info btn-sm" href="{{ route('ak_banding.berkas.cek-split', $asesmen->id) }}" target="_blank">
            ...
            <div class="card-header kriteria-header" id="heading-kriteria-{{ $kriteria->id }}">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        fn($e) => $e->penilaianElemenAkBanding->isNotEmpty()
                        && $e->penilaianElemenAkBanding->first()->skor !== null
                        )->count();
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function pollImportStatus(importLogId) {
            ...
            pollingInterval = setInterval(async () => {
                ...
                try {
                    const response = await fetch(`/ak-banding/import-status/${importLogId}`, {
                        headers: {
                            'Accept': 'application/json'
                            , 'X-CSRF-TOKEN': '{{ csrf_token() }}'
                        }
    ...
    `;
        ...
        window.refreshSplitStatus = async function() {
            try {
                const res = await fetch(`/ak-banding/berkas/${idAsesmen}/check-split-result`, {
                    headers: {
                        'Accept': 'application/json'
                        , 'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    , }
        ...
        function buildSplitInfoHTML(data) {
            ...
            const cekSplitUrl = `/ak-banding/berkas/${idAsesmen}/cek-split`;
            const berkasUrl = `/ak-banding/berkas/${idAsesmen}`;
