{{-- resources/views/asesmen/ak-banding/berkas/upload-excel.blade.php --}}

@extends('layouts.template.app')

@section('title', 'Upload Penilaian Excel AK Banding - ' . $asesmen->name)
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                <div>
                    <h4 class="mb-1">
                        <i class="bi bi-upload"></i> Upload Penilaian AK Banding
                    </h4>
                    ...
                    <div class="alert alert-warning alert-dismissible alert-permanent mb-3">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <hr>
                                <div class="mb-0">
                                    <a href="{{ route('ak_banding.berkas.show', $asesmen->id) }}" class="btn btn-sm btn-warning">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-cloud-upload"></i> Upload File Penilaian AK Banding
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="upload-area" id="uploadArea">
                            ...
                            <div id="uploadPrompt">
                                ...
                                <h5 class="mt-3">
                                    ...
                                    @else
                                    Silahkan Upload File Excel Penilaian AK Banding di Sini
                                    @endif
                                </h5>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4 text-center">
                        <a href="{{ route('ak_banding.berkas.export', ['idAsesmen' => $asesmen->id, 'mode' => 'template']) }}" class="btn btn-md btn-outline-primary">
                            <i class="bi bi-download"></i> Download Templat Penilaian AK Banding
                        </a>
                    </div>
                </div>
            </div>
