...
@section('title', 'Validasi AK Banding')
...
<div class="container-fluid py-3">
    ...
    <div class="welcome-section mb-4">
        <div class="welcome-content">
            ...
            <p class="mb-0">Validasi penilaian asesor banding untuk Asesmen Kecukupan Banding (AK)</p>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Validasi AK Banding</li>
        </ol>
    </nav>

    <div class="alert alert-info alert-permanent">
        <i class="bi bi-bell-fill"></i>
        <strong>Validasi AK Banding</strong><br>
        Validasi AK Banding dapat dilihat pada daftar berikut<br>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="bi bi-list-check"></i> Daftar Validasi AK Banding
                </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge bg-secondary">
                                    <i class="bi bi-exclamation-triangle"></i> Menunggu Penugasan Asesor Banding
                                </span>
                                @elseif(!$allSubmitted)
                                <span class="badge bg-warning text-dark">
                                    <i class="bi bi-clock"></i> Menunggu Asesor Banding Submit
                                </span>
                                @else
                            ...
                            <td class="text-center">
                                @if($isValidated)
                                <a href="{{ route('ak_banding.validasi.asesor', ['idAsesmen' => $asesmen->id, 'jenisAsesmen' => 'ak_banding']) }}" class="btn btn-sm btn-outline-success" title="Lihat Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                @else
                                @if($hasMinAsesor && $allSubmitted)
                                <a href="{{ route('ak_banding.validasi.asesor', ['idAsesmen' => $asesmen->id, 'jenisAsesmen' => 'ak_banding']) }}" class="btn btn-sm btn-primary" title="Validasi">
    ...
    <div class="row mt-4 row-cols-1 row-cols-md-2 row-cols-lg-4 g-3">
        <div class="col">
            <x-stat-card title="Asesor Banding Sudah Submit" :value="$stats['total_asesor_submitted']" icon="people" mode="white" description="" color="warning" />
        </div>
        <div class="col">
            <x-stat-card title="Asesor Banding Belum Submit" :value="$stats['total_asesor_pending']" icon="exclamation-triangle" mode="white" description="" color="danger" />
        </div>
        <div class="col">
    ...
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <h5 class="mt-3 mb-2">Tidak Ada Validasi AK Banding</h5>
            <p class="text-muted mb-4">
                Anda belum memiliki penugasan untuk melakukan validasi AK Banding saat ini.<br>
                Validasi AK Banding akan muncul setelah proses penugasan asesor AK Banding selesai.
            </p>
        </div>
    </div>
    @endif
        ...
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title">
                    <i class="bi bi-people-fill"></i> Daftar Asesor Banding yang Sudah Submit
                </h5>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title">
                    <i class="bi bi-exclamation-triangle-fill"></i> Daftar Asesor Banding yang Belum Submit
                </h5>
            ...
            <div class="modal-body">
                ...
                @empty
                <p class="text-center text-muted mb-0">Semua asesor banding sudah submit! 🎉</p>
                @endforelse
            </div>
        </div>
    </div>
