        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                ...
                <div id="comparisonContainer" style="display: none;">
                    ...
                    <div class="comparison-matrix-wrapper" style="overflow-x: auto; overflow-y: auto; max-height: calc(100vh - 200px);">
...
<script>
    ...
    async function openComparisonModal(idAsesmen) {
        const modalEl = document.getElementById('modalComparisonAsesor');
    ...
    function populateComparisonModal(data) {
        ...
        <tr>
            ...
            <th class="comp-header comp-sticky-col comp-sticky-header" style="left: 100px; min-width: 35px; max-width: 35px; z-index: 35;">
    ...
    `;
        ...
        <th class="comp-header comp-sticky-header col-ket-split" style="min-width: 300px; z-index: 30;">
            ...
            `;
                ...
                asesors.forEach(asesor => {
                    ...
                    <td class="comp-cell comp-score-cell comp-score-merged" style="background: ${bgMerged};" ${onclickMerged}>
                        ${skor !== null ? `<small class="text-dark">${(komentar || 'Tidak ada komentar').substring(0, 100)}...</small>` : '<span class="text-muted">Belum dinilai</span>'}
                    </td>
                `;
                });
    ...
    function setupToggleIndikatorButton() {
        ...
        btn.addEventListener('click', function() {
            ...
            if (window.COMPARISON_UI.showIndikator) {
                modalEl.classList.add('show-indikator');
                this.innerHTML = '<i class="bi bi-list-ul"></i> Sembunyikan Indikator';
                this.classList.remove('btn-outline-primary');
                this.classList.add('btn-primary');
            } else {
                modalEl.classList.remove('show-indikator');
