{{-- resources\views\asesmen\banding\ak-banding\components\modal-detail-validasi.blade.php --}}
<div class="modal fade" id="modalDetailValidasi" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-secondary text-white">
                <h5 class="modal-title">
                    <i class="bi bi-eye"></i> Detail Hasil Validasi AK Banding
                </h5>
                ...
                <div id="contentDetailValidasi" style="display: none;">
                    ...
                    <div class="card mb-3">
                        <div class="card-header bg-secondary text-white">
                            <h6 class="mb-0">
                                <i class="bi bi-check-circle"></i> Hasil Validasi Banding
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <small class="text-muted">Validator Banding:</small>
                    ...
                    <div class="card">
                        <div class="card-header bg-secondary text-white">
                            <h6 class="mb-0">
                                <i class="bi bi-people"></i> Penilaian Asesor Banding
                            </h6>
                        </div>
                        <div class="card-body">
