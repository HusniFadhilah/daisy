{{-- resources\views\asesmen\banding\ak-banding\components\finalisasi-button.blade.php --}}
@php
...
$isRouteBerkasShow = request()->routeIs('ak_banding.berkas.show*');
...
@include('asesmen.banding.ak-banding.components.split-table-container')
