        ...
        <div class="matrix-wrapper" style="overflow-x: auto; overflow-y: auto; max-height: 600px;">
            <table class="matrix-table" id="heatmapMatrix">
                ...
                <tbody>
                    ...
                    @php
                    // Get penilaianElemenAkBanding for this elemen (not indikator!)
                    ...
                    <tr>
                        ...
                        {{-- Kolom Pemenuhan --}}
                        <td class="matrix-cell" data-elemen-id="{{ $elemen->id }}" data-kriteria-id="{{ $kriteria->id }}" data-col="pemenuhan" style="background-color: {{ $hasPenilaian ? $penilaianElemenAkBanding->skor == 4 ? '#e0e0e0' : \App\Models\JenjangPenilaian::getSkorColor($penilaianElemenAkBanding->skor) : '#e0e0e0' }}">
                        </td>

                        {{-- Kolom Pelampauan --}}
                        <td class="matrix-cell" data-elemen-id="{{ $elemen->id }}" data-kriteria-id="{{ $kriteria->id }}" data-col="pelampauan" style="background-color: {{ $hasPenilaian ? $penilaianElemenAkBanding->skor == 4 ? \App\Models\JenjangPenilaian::getSkorColor(4) : '#e0e0e0' : '#e0e0e0' }}">
                        </td>
                    </tr>
                    @endforeach
                    @endforeach
