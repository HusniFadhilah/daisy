...
--}}
    ...
    $isShowPage = request()->routeIs('ak_banding.berkas.show*');
    @endphp
    ...
    <small class="d-block text-muted mt-1">
        ...
        @elseif($reason === 'other_not_done') Menunggu asesor banding lain menyelesaikan penilaian
        @elseif($reason === 'has_split') Selesaikan diskusi split penilaian terlebih dahulu
        @else Semua asesor banding selesai &amp; tidak ada split — siap finalisasi
        @endif
    </small>
    ...
    <div class="mt-2 p-2 bg-light rounded border">
        <small class="text-muted d-block mb-2 fw-semibold">
            <i class="bi bi-people me-1"></i> Status Pengisian Asesor Banding:
        </small>
        ...
        <div class="d-flex align-items-center justify-content-between gap-2">
            <div>
                ...
                <small class="d-block text-danger">
                    Selesaikan perbedaan penilaian antar asesor banding sebelum finalisasi.
                </small>
            </div>
            <a href="{{ route('ak_banding.berkas.cek-split', $asesmen->id) }}" class="btn btn-sm btn-outline-dark" target="_blank">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ $isShowPage
                            ...
                            : route('ak_banding.berkas.show', $asesmen->id).'#elemen-'.$item['elemenId'] }}" class="btn btn-sm btn-outline-dark">
