...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted mb-0">Kelola penawaran penilaian akreditasi yang ditawarkan kepada Anda</p>
    </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->status_penawaran === 'accepted')
                                <a href="{{ route('ak.berkas.show',$item->id) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-arrow-right"></i> Buka Penilaian
                                </a>
                                @endif
                            </td>
                        </tr>
