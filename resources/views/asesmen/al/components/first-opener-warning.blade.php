{{-- resources/views/asesmen/al/components/first-opener-warning.blade.php --}}

@extends('layouts.template.app')

@section('title', 'Konfirmasi Akses Penilaian AL')
...
<div class="container py-5" style="max-width: 640px;">
    ...
    <div class="text-center mb-4">
        ...
        <h4 class="fw-bold">Anda Akan Membuka Halaman Penilaian AL</h4>
        <p class="text-muted">Belum ada asesor lain yang membuka halaman ini sebelumnya.</p>
        @else
        <div class="mb-3">
            <span style="font-size: 4rem;">🔒</span>
        </div>
        <h4 class="fw-bold">Halaman Penilaian Sudah Diambil</h4>
        <p class="text-muted">
            Asesor lain sudah lebih dulu membuka halaman penilaian AL ini.
        </p>
        @endif
    </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="alert alert-success alert-permanent border-start border-2 border-success mb-4">
                <h6 class="fw-bold mb-2">
                    <i class="bi bi-shield-check me-2"></i>Hak Penilaian Akan Diberikan kepada Anda
                </h6>
                <p class="mb-2 small">
                    Begitu Anda klik <strong>Lanjutkan</strong>, Anda menjadi satu-satunya asesor
                    yang dapat:
                </p>
                <ul class="mb-0 small">
            ...
            <div class="alert alert-warning alert-permanent border-start border-2 border-warning mb-4">
                <h6 class="fw-bold mb-1">
                    <i class="bi bi-people me-2"></i>Asesor Lain Tidak Akan Bisa Mengisi
                </h6>
                <p class="mb-0 small">
                    Setelah Anda lanjutkan, asesor lain dalam tim akan mendapat pesan
            ...
            <div class="alert alert-danger alert-permanent border-start border-2 border-danger mb-4">
                <h6 class="fw-bold mb-2">
                    ...
                    Penilaian Sudah Diklaim oleh
                    <strong>{{ $firstOpenerUser?->name ?? 'Asesor Lain' }}</strong>
                </h6>
                <p class="mb-2 small">
                    Asesor <strong>{{ $firstOpenerUser?->name ?? 'lain' }}</strong> sudah lebih
