{{-- resources/views/asesmen/pelaporan/banding/validasi-ak-banding-show.blade.php --}}

@extends('layouts.template.app')

@section('title', 'Detail Pelaporan Validasi AK Banding')
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('pelaporan.banding.indexValidasiAK') }}">Pelaporan Validasi AK Banding</a>
            </li>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h5 class="mb-1">
                <i class="bi bi-clipboard-check"></i> Detail Pelaporan Validasi AK Banding
            </h5>
            @if($pengajuan)
        ...
        <a href="{{ route('pelaporan.banding.indexValidasiAK') }}" class="btn btn-secondary">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <!-- Status Alert -->
            @php
            $isReported = $pengajuan && !empty($pengajuan->tanggal_pelaporan_ak_banding);
            $canReport = $pengajuan && $pengajuan->canBeReported('ak_banding');
            @endphp

            @if($isReported)
            <div class="alert alert-success alert-permanent mb-4">
                <i class="bi bi-check-circle"></i>
                <strong>Pelaporan Validasi AK Banding telah selesai</strong>
                <br>
                Dilaporkan pada {{ $pengajuan->tanggal_pelaporan_ak_banding->locale('id')->translatedFormat('d M Y H:i') }}
            </div>
            @elseif($canReport)
            <div class="alert alert-warning alert-permanent mb-4">
                <i class="bi bi-hourglass-split"></i>
                <strong>Menunggu Pelaporan Validasi AK Banding</strong>
                <br>
                Silakan upload dan finalisasi laporan validasi AK Banding
            </div>
            @else
            ...
            <!-- File Laporan Validasi AK Banding -->
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mt-2 mb-0">Belum ada file laporan validasi AK Banding</p>
                        @if($canReport)
                        <button type="button" class="btn btn-info mt-3 js-open-pelaporan" data-type="ak_banding" data-assignment-id="{{ $assignment->id }}" data-nomor="{{ $pengajuan->nomor_pengajuan ?? $assignment->asesmen->code }}">
            ...
            <div class="card mt-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Informasi Pelaporan Validasi AK Banding</h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless">
                        @if($pengajuan)
                        <tr>
                            <th>Tanggal Pelaporan Validasi AK Banding</th>
                            <td>: {{ \App\Libraries\Date::tglIndo($pengajuan->tanggal_pelaporan_ak_banding) }}</td>
                        </tr>
                        <tr>
