{{-- resources/views/asesmen/pelaporan/banding/al-banding.blade.php --}}
                        ...
                        <tr class="assignment-row" data-status="{{ $statusClass }}" data-name="{{ strtolower($prodi) }}" data-university="{{ strtolower($univ) }}" data-date="{{ $ts }}">
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button type="button" class="btn btn-info js-open-pelaporan" title="Upload Pelaporan" data-type="al_banding" data-assignment-id="{{ $assignment->id }}" data-nomor="{{ $nomor }}">
