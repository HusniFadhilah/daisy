{{-- resources/views/upps/masa-sanggah/show.blade.php --}}
...
<div class="container-fluid py-3">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('upps.masa-sanggah') }}">Masa Sanggah</a></li>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('upps.masa-sanggah') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless mb-0">
                        <tr>
                            ...
                            <td>: {!! $pengajuan->getCustomBadgeLastStatus('banding', 'upps') !!}</td>
                        </tr>
                        <tr>
