{{-- resources/views/upps/penyimpanan-arsip-pelaksanaan-akreditasi/index.blade.php --}}
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-2 opacity-75">Total Arsip Tersimpan</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $stats['total'] }}</h2>
                            <small class="opacity-75">Dokumen akreditasi</small>
                        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #ffc107 0%, #ff8c00 100%);">
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $stats['by_peringkat']['Unggul'] ?? 0 }}</h2>
                            <small class="opacity-75">Program studi</small>
                        </div>
                        <div style="background: rgba(255,255,255,0.2); width: 60px; height: 60px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 28px;">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('upps.penyimpanan-arsip-pelaksanaan-akreditasi.show', $pengajuan->id) }}" class="btn btn-info btn-sm" title="Lihat Detail Arsip">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <div class="text-center py-5">
                        ...
                        @if(request()->filled('search') || request()->filled('peringkat'))
                        <a href="{{ route('upps.penyimpanan-arsip-pelaksanaan-akreditasi') }}" class="btn btn-sm btn-info">
