    ...
    <div class="row mb-4">
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-2 opacity-75">Total Hasil Ditetapkan</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $stats['total'] }}</h2>
                            <small class="opacity-75">Hasil akhir akreditasi</small>
                        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card stat-card p-0" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                <div class="card-body text-white">
                    <h6 class="mb-2 opacity-75">Sudah Diumumkan</h6>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $stats['diumumkan'] }}</h2>
                            <small class="opacity-75">Pengumuman resmi</small>
                        </div>
                        <div style="background: rgba(255,255,255,0.2); width: 60px; height: 60px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 28px;">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
            <div class="card filter-card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('upps.penetapan-hasil-akreditasi') }}">
                        <!-- Search -->
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('upps.penetapan-hasil-akreditasi') }}" class="btn btn-outline-light">
