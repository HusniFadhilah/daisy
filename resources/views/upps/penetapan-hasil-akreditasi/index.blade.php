...
<div class="container-fluid py-3">
    ...
    <div class="alert alert-info alert-permanent">
        ...
        Penetapan hasil akreditasi program studi tersedia pada daftar berikut
    </div>
                ...
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th width="15%">Penetapan Hasil Akreditasi</th>
                                    <th width="20%">Status Penetapan Hasil</th>
                                    <th width="20%">Tanggal Penetapan Hasil</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! $pengajuan->getCustomBadgeLastStatus('penetapan_hasil','upps','label_short_for','text-dark') !!}
                                    </td>
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mt-3">
                            ...
                            @else
                            Belum ada hasil akreditasi yang ditetapkan
                            @endif
                        </p>
                        @if(request()->filled('search') || request()->filled('status') || request()->filled('peringkat'))
