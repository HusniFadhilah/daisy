{{-- resources/views/upps/penetapan-hasil-akreditasi/components/table-content.blade.php --}}
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    ...
                    // Tanggal tampil (prioritas finalisasi -> penetapan -> created_at)
                    $tanggalLabel = null;
                    ...
                    $tanggalKeterangan = 'Hasil ditetapkan';
                    } else {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('upps.penetapan-hasil-akreditasi.show', $pengajuan->id) }}" class="btn btn-sm btn-primary" title="Lihat Detail">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
