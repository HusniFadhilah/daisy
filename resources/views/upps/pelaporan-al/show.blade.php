            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                            <th style="width:40%">Tanggal Penilaian AL Selesai</th>
                            <td>
                                : {{ $pengajuan->tanggal_al_selesai
                                    ? $pengajuan->tanggal_al_selesai->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                : {{ $pengajuan->tanggal_pelaporan_al
                                    ? $pengajuan->tanggal_pelaporan_al->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
            ...
            {{-- <div class="card mt-4 border-info">
                ...
                <div class="card-body">
                    ...
                    <p class="small text-muted mb-0">
                        Pelaporan AL merupakan tahap akhir dari proses penilaian kecukupan dokumen sebelum dilanjutkan ke tahap Asesmen Lapangan.
                    </p>
                </div>
            </div> --}}
        </div>
