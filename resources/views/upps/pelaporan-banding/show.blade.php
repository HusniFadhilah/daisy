...
<div class="container-fluid py-3">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <div>
            <h5 class="mb-1">
                <i class="bi bi-journal-text"></i> Detail Pelaporan Banding
            </h5>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            ...
            <div class="alert alert-success alert-permanent">
                ...
                Permohonan akreditasi program studi memasuki tahap pelaporan Banding
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header bg-secondary text-white">
                    <h5 class="mb-0">
                        <i class="bi bi-info-circle"></i> Informasi Pelaporan Banding
                    </h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                            <th style="width:40%">Tanggal Penilaian AL Banding Selesai</th>
                            <td>
                                : {{ $pengajuan->tanggal_al_banding_selesai
                                    ? $pengajuan->tanggal_al_banding_selesai->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                : {{ $pengajuan->tanggal_pelaporan_al_banding
                                    ? $pengajuan->tanggal_pelaporan_al_banding->locale('id')->translatedFormat('d M Y H:i')
                                    : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <th>Status Pelaporan Banding</th>
                            <td>: {!! $pengajuan->getCustomBadgeLastStatus('pelaporan_al_banding', 'upps', 'label_long_for') !!}</td>
                        </tr>
                    </table>
                </div>
            </div>
