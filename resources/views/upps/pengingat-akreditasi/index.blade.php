...
<div class="container-fluid py-3">
    ...
    <div class="alert alert-light alert-permanent fade show border-start border-1 border-secondary" role="alert">
            ...
            <div class="w-100">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-2">
                    <div>
                        ...
                        <br>Mohon menyiapkan permohonan akreditasi minimal <strong>6 bulan</strong> sebelum masa akreditasi habis.
                    </div>
