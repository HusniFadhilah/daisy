...
<div class="container-fluid py-3">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted">
            Lengkapi dan kirim permohonan akreditasi | Nomor: <strong>{{ $pengajuan->nomor_pengajuan }}</strong>
        </p>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">
                                    {{ $existingDokumen ? 'Ganti' : 'Upload' }} Surat Permohonan Akreditasi (PDF)
                ...
                <div class="card border-warning mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <ol class="mb-0 ps-3 small">
                            ...
                            <li>
                                <strong>Kirim Permohonan:</strong> Kirim permohonan akreditasi ke LAMDEPILAR
                            </li>
                        </ol>
                    </div>
                </div>
