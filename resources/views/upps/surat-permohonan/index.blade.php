...
<div class="container-fluid py-3">
    ...
    <div class="alert alert-info alert-permanent">
        ...
        <strong>Permohonan Akreditasi</strong><br>
        Permohonan akreditasi program studi tersedia pada tombol berikut
    </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th width="22%">Tanggal Permohonan Dikirim</th>
                                    <th width="23%">Status Permohonan Akreditasi</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <a href="{{ route('upps.surat-permohonan.download', $pengajuan->id) }}" class="btn btn-outline-success" title="Lihat File Permohonan Akreditasi">
