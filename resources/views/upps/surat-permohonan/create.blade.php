...
@section('title', 'Buat Permohonan Akreditasi')
...
<div class="container-fluid py-3">
    ...
    <div class="mb-4">
        <h4>
            ...
            Buat Permohonan Akreditasi Baru
        </h4>
        <p class="text-muted">
            Lengkapi formulir untuk mengajukan permohonan akreditasi program studi
        </p>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">
                                    Surat Permohonan Akreditasi (PDF)
