                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('id_study_program') is-invalid @enderror" id="id_study_program" name="id_study_program" data-no-select2>
                            ...
                            @if(old('id_study_program', $user->id_study_program) && $user->studyProgram)
                            <option value="{{ $user->studyProgram->id }}" selected>
                                {{ $user->studyProgram->name }}{{ $user->studyProgram->degreeLevel ? ' ('.$user->studyProgram->degreeLevel->name.')' : '' }}
                            </option>
                            @endif
                        </select>
