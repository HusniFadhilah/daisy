            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('role_selected') is-invalid @enderror" id="role_selected" name="role_selected" required>
                        ...
                        <option value="keuangan_lamdepilar" {{ old('role_selected', $user->role_selected) === 'keuangan_lamdepilar' ? 'selected' : '' }}>Keuangan LAMDEPILAR</option>
                        <option value="asesor" {{ old('role_selected', $user->role_selected) === 'asesor' ? 'selected' : '' }}>Asesor</option>
                        <option value="asesor_banding" {{ old('role_selected', $user->role_selected) === 'asesor_banding' ? 'selected' : '' }}>Asesor Banding</option>
                ...
                <div class="mb-3">
                    ...
                    <div class="border rounded p-3 bg-light">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="roles[]" value="keuangan_lamdepilar" id="edit_role_keuangan_lamdepilar" {{ in_array('keuangan_lamdepilar', old('roles', $user->roles ?? [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="edit_role_keuangan_lamdepilar">Keuangan LAMDEPILAR</label>
                        </div>
                        <div class="form-check">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="roles[]" value="asesor_banding" id="edit_role_asesor_banding" {{ in_array('asesor_banding', old('roles', $user->roles ?? [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="edit_role_asesor_banding">Asesor Banding</label>
                        </div>
                        <div class="form-check">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('id_study_programs') is-invalid @enderror @error('id_study_programs.*') is-invalid @enderror" id="id_study_programs" name="id_study_programs[]" multiple data-no-select2>
                            ...
                            <option value="{{ $studyProgram->id }}" {{ in_array($studyProgram->id, $selectedStudyProgramIds, true) ? 'selected' : '' }}>
                                {{ $studyProgram->name }}{{ $studyProgram->degreeLevel ? ' ('.$studyProgram->degreeLevel->name.')' : '' }}
                            </option>
                            @endforeach
                        </select>
