...
<p style="margin-top:0;">
    Yth. Tim Akreditasi Program Studi <strong>{{ $pengajuan->studyProgram->name }}</strong>,
</p>

<p>
    Bersama email ini kami sampaikan bahwa <strong>Surat Penerimaan Permohonan Banding</strong>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#e9f7ef;border-left:4px solid #198754;margin:20px 0;">
    <tr>
        <td style="padding:15px;font-size:14px;line-height:1.8;">
            ...
            Surat penerimaan permohonan banding telah <strong>disertakan sebagai lampiran</strong>
            pada email ini. Silakan unduh dan gunakan dokumen tersebut sesuai kebutuhan proses banding.
        </td>
    </tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" style="margin:10px 0 20px 0;">
    <tr>
        <td style="font-size:14px;line-height:1.8;">
            ...
            • Buka detail penerimaan permohonan banding<br>
            • Periksa status terbaru dan dokumen yang telah diterbitkan<br>
            • Lanjutkan proses banding sesuai tahapan yang berlaku
        </td>
    </tr>
</table>
    ...
    <tr>
        <td align="center">
            <a href="{{ $actionUrl }}" style="background:#932136;color:#ffffff;text-decoration:none;
                ...
                Lihat Detail Permohonan Banding
            </a>
        </td>
    </tr>
</table>
