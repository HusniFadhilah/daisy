            ...
            <form action="{{ route('study-programs.update', $studyProgram->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('id_univ') is-invalid @enderror" id="id_univ" name="id_univ" required>
                        ...
                        <option value="{{ $university->id }}" {{ old('id_univ', $studyProgram->id_univ) == $university->id ? 'selected' : '' }}>
                            {{ $university->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('id_level') is-invalid @enderror" id="id_level" name="id_level" required>
                        ...
                        <option value="{{ $level->id }}" {{ old('id_level', $studyProgram->id_level) == $level->id ? 'selected' : '' }}>
                            {{ $level->name }}
                        </option>
                        @endforeach
                    </select>
