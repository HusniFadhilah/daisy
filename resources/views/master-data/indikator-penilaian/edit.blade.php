            ...
            <form action="{{ route('indikator-penilaian.update', $indikatorPenilaian->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('id_elemen') is-invalid @enderror" id="id_elemen" name="id_elemen" required>
                        ...
                        <option value="{{ $elemen->id }}" {{ old('id_elemen', $indikatorPenilaian->id_elemen) == $elemen->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('id_jenjang_penilaian') is-invalid @enderror" id="id_jenjang_penilaian" name="id_jenjang_penilaian" required>
                        ...
                        <option value="{{ $jenjang->id }}" {{ old('id_jenjang_penilaian', $indikatorPenilaian->id_jenjang_penilaian) == $jenjang->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('deskripsi_penilaian') is-invalid @enderror" id="deskripsi_penilaian" name="deskripsi_penilaian" rows="4" placeholder="Masukkan deskripsi kriteria penilaian..." required>{{ old('deskripsi_penilaian', $indikatorPenilaian->deskripsi_penilaian) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="2" placeholder="Masukkan keterangan tambahan (opsional)">{{ old('keterangan', $indikatorPenilaian->keterangan) }}</textarea>
                    @error('keterangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
