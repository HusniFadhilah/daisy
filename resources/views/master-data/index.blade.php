...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs mb-4" id="masterDataTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link {{ $tab == 'universities' ? 'active' : '' }}" id="universities-tab" data-bs-toggle="tab" data-bs-target="#universities" type="button" role="tab">
                <i class="bi bi-building"></i> Universitas
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link {{ $tab == 'study-programs' ? 'active' : '' }}" id="study-programs-tab" data-bs-toggle="tab" data-bs-target="#study-programs" type="button" role="tab">
    ...
    <div class="tab-content" id="masterDataTabContent">
        <!-- Universities Tab -->
        <div class="tab-pane fade {{ $tab == 'universities' ? 'show active' : '' }}" id="universities" role="tabpanel">
        ...
        <!-- Study Programs Tab -->
        <div class="tab-pane fade {{ $tab == 'study-programs' ? 'show active' : '' }}" id="study-programs" role="tabpanel">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle" id="studyProgramsTable">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($program->status_kedaluwarsa)
                                        @php
                                        $statusLower = strtolower($program->status_kedaluwarsa);
                                        $badgeColor = 'secondary';
                                        if (str_contains($statusLower, 'berlaku')) {
                                        $badgeColor = 'success';
                                        } elseif (str_contains($statusLower, 'kedaluwarsa') || str_contains($statusLower, 'hari lagi')) {
                                        $badgeColor = 'warning';
                                        }
                                        @endphp
                                        <span class="badge bg-{{ $badgeColor }}">{{ $program->status_kedaluwarsa }}</span>
                                        @else
