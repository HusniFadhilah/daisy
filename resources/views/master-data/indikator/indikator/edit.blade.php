        ...
        <div class="card-body">
            <form action="{{ route('indikator.update', $indikator->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_indikator" class="form-control @error('kode_indikator') is-invalid @enderror" value="{{ old('kode_indikator', $indikator->kode_indikator) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi_indikator" class="form-control @error('deskripsi_indikator') is-invalid @enderror" rows="4" required>{{ old('deskripsi_indikator', $indikator->deskripsi_indikator) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <select name="id_elemen" class="form-select @error('id_elemen') is-invalid @enderror" required>
                        ...
                        <option value="{{ $elemen->id }}" {{ old('id_elemen', $indikator->id_elemen) == $elemen->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <select name="id_jenis" class="form-select @error('id_jenis') is-invalid @enderror" required>
                        ...
                        <option value="{{ $jenis->id }}" {{ old('id_jenis', $indikator->id_jenis) == $jenis->id ? 'selected' : '' }}>
                            {{ $jenis->nama_jenis }}
                        </option>
                        @endforeach
                    </select>
