            ...
            <form action="{{ route('study-programs.update', $studyProgram->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('peringkat_akreditasi') is-invalid @enderror" id="peringkat_akreditasi" name="peringkat_akreditasi">
                        ...
                        <option value="Unggul" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'Unggul' ? 'selected' : '' }}>Unggul</option>
                        <option value="Baik Sekali" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'Baik Sekali' ? 'selected' : '' }}>Baik Sekali</option>
                        <option value="Baik" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'Baik' ? 'selected' : '' }}>Baik</option>
                        <option value="Terakreditasi" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'Terakreditasi' ? 'selected' : '' }}>Terakreditasi</option>
                        <option value="Terakreditasi Sementara" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'Terakreditasi Sementara' ? 'selected' : '' }}>Terakreditasi Sementara</option>
                        <option value="Terakreditasi Pertama" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'Terakreditasi Pertama' ? 'selected' : '' }}>Terakreditasi Pertama</option>
                        ...
                        <option value="A" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'A' ? 'selected' : '' }}>A</option>
                        <option value="B" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'B' ? 'selected' : '' }}>B</option>
                        <option value="C" {{ old('peringkat_akreditasi', $studyProgram->peringkat_akreditasi) == 'C' ? 'selected' : '' }}>C</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('no_sk') is-invalid @enderror" id="no_sk" name="no_sk" value="{{ old('no_sk', $studyProgram->no_sk) }}" placeholder="Contoh: 1234/SK/BAN-PT/Akred/S/V/2026">
                    @error('no_sk')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
